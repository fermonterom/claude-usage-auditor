...
function loadEventsForDates(dateList) {
  ...
  for (const date of dateList) {
    ...
    // Eliminar BOM UTF-8 si el editor lo añadió
  ...
  if (skipped > 0 && (process.env.NGAI_DEBUG || process.env.NEXTGENAI_DEBUG)) {
    process.stderr.write(`[aggregate] ${skipped} líneas JSONL malformadas ignoradas\n`);
  }
  return events;
}
